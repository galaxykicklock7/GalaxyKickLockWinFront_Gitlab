const appState = {
    ...
    gameState: {
        ...
        inc4: 0,
        lowtime: 0,
        // Flags to track if bot should rejoin target planet after escape/kick/ban
        shouldRejoinPlanet1: false,
        shouldRejoinPlanet2: false,
        shouldRejoinPlanet3: false,
        shouldRejoinPlanet4: false,
        shouldRejoinPlanet5: false,
        // Flags to track if bot is currently in prison (persists across reconnections)
        inPrison1: false,
        inPrison2: false,
        inPrison3: false,
        inPrison4: false,
