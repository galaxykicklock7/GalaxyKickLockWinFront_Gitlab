-- =====================================================
-- UPDATE get_imprisonment_metrics TO INCLUDE adjustment_reason
-- =====================================================
-- Adds adjustment_reason to the response
-- =====================================================
...
BEGIN
  ...
  -- Get metrics with ALL fields including ML data AND adjustment_reason
  ...
  FROM (
    SELECT json_build_object(
      ...
      'pingMs', ping_ms,
      'context', context,
      'adjustmentReason', adjustment_reason,  -- NEW FIELD
