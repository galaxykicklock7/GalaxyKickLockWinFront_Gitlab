-- =====================================================
-- UPDATE record_imprisonment_metric TO INCLUDE PING AND CONTEXT
-- =====================================================
-- This adds p_ping_ms and p_context parameters to the function
-- Run this AFTER AI_CORE_COMPLETE_SETUP.sql
-- =====================================================
...
-- Updated function with timing, ping, and context parameters
...
BEGIN
  ...
  -- Insert metric with ALL fields including ping_ms and context
...
-- Update grant permissions for new function signature
GRANT EXECUTE ON FUNCTION public.record_imprisonment_metric(UUID, INTEGER, INTEGER, TEXT, TEXT, BOOLEAN, BOOLEAN, INTEGER, TEXT, INTEGER, TEXT) TO anon, authenticated;
