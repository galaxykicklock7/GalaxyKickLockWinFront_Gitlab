...
-- Matches EXACT function signature from database
-- =====================================================

-- Drop BOTH versions of the function (9 params and 11 params)
...
-- Create function matching EXACT signature from database (with ping_ms and context)
...
BEGIN
  ...
  -- Insert metric (all fields including ping_ms and context)
